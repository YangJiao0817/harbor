...
func (o *ListArtifactsURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on ListArtifactsURL")
	}
	...
	if repositoryName != "" {
		...
		return nil, errors.New("repositoryName is required on ListArtifactsURL")
	}
	...
	var withAccessoryQ string
	if o.WithAccessory != nil {
		withAccessoryQ = swag.FormatBool(*o.WithAccessory)
	}
	if withAccessoryQ != "" {
		qs.Set("with_accessory", withAccessoryQ)
	}
...
func (o *ListArtifactsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListArtifactsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListArtifactsURL")
	}
