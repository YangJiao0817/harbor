...
// StopScanArtifactParams contains all the bound params for the stop scan artifact operation
// typically these are obtained from a http.Request
//
// swagger:parameters stopScanArtifact
...
//
// To ensure default values, the struct must have been initialized with NewStopScanArtifactParams() beforehand.
func (o *StopScanArtifactParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *StopScanArtifactParams) bindXRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *StopScanArtifactParams) validateXRequestID(formats strfmt.Registry) error {
...
func (o *StopScanArtifactParams) bindProjectName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *StopScanArtifactParams) bindReference(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *StopScanArtifactParams) bindRepositoryName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
