...
// CreatePurgeScheduleParams contains all the bound params for the create purge schedule operation
// typically these are obtained from a http.Request
//
// swagger:parameters createPurgeSchedule
...
//
// To ensure default values, the struct must have been initialized with NewCreatePurgeScheduleParams() beforehand.
func (o *CreatePurgeScheduleParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreatePurgeScheduleParams) bindXRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreatePurgeScheduleParams) validateXRequestID(formats strfmt.Registry) error {
