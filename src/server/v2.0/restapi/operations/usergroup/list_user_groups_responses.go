...
// WithLink adds the link to the list user groups o k response
func (o *ListUserGroupsOK) WithLink(link string) *ListUserGroupsOK {
	o.Link = link
	return o
}

// SetLink sets the link to the list user groups o k response
func (o *ListUserGroupsOK) SetLink(link string) {
	o.Link = link
}

// WithXTotalCount adds the xTotalCount to the list user groups o k response
func (o *ListUserGroupsOK) WithXTotalCount(xTotalCount int64) *ListUserGroupsOK {
	o.XTotalCount = xTotalCount
	return o
}

// SetXTotalCount sets the xTotalCount to the list user groups o k response
func (o *ListUserGroupsOK) SetXTotalCount(xTotalCount int64) {
	o.XTotalCount = xTotalCount
}
